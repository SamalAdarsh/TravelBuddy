    ...
    <section className="min-h-screen relative overflow-hidden bg-linear-to-br from-indigo-50 to-blue-100 flexCenter py-22">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
        <div className="inline-flex items-center space-x-2 bg-white/60 backdrop-blur-md px-4 py-2 rounded-full mb-6 border-white/50 shadow-sm ">
          ...
          <span className="text-sm font-medium text-indigo-900">AI-Powered Travel Guide v2.0</span>
        </div>
        <h1 className="text-5xl md:text-7xl font-extrabold text-transparent bg-clip-text bg-linear-to-r from-indigo-600 to-purple-600 mb-6 tracking-tight leading-tight">Plan Your Dream Getaway in Seconds</h1>
        ...
        <Button className="group relative inline-flexCenter px-8! py-8! text-lg font-bold text-white transition-all duration-200 bg-indigo-600 rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600 hover:bg-indigo-700 hover:scale-105 shadow-xl "> Start Planning <FaArrowRightLong className="ml-2 w-5! h-5! group-hover:translate-x-1 transition-transform"/></Button>
